...
wget https://raw.githubusercontent.com/openvinotoolkit/openvino_build_deploy/master/ai_ref_kits/automated_self_checkout/setup/utilities.sh -O utilities.sh

wget https://raw.githubusercontent.com/openvinotoolkit/openvino_build_deploy/master/ai_ref_kits/automated_self_checkout/setup/installEnv.sh -O installEnv.sh
