...
def main(args):
    ...
    chat_model_dir = chat.convert_chat_model(args.chat_model_type, args.precision, Path(args.model_dir))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--precision", type=str, default="int4", choices=["fp16", "int8", "int4"], help="Chat model precision")
