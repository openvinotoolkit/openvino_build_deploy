    ...
    with gr.Blocks(theme=utils.gradio_intel_theme(), title="Paint Your Dreams with OpenVINO") as demo:
        ...
        with gr.Group():
            with gr.Row(equal_height=True):
                prompt_text = gr.Text(label="Prompt", placeholder="Enter your prompt here", value=random.choice(examples_t2i), scale=5)    #nosec B311
        ...
        def update_model_config(model_name):
            ...
            adapter_choices = ["None"] + config["lora_adapters"]
