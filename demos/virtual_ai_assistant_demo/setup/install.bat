...
:: Navigate to Virtual AI Assistant Demo directory
cd /d "%INSTALL_DIR%\demos\virtual_ai_assistant_demo"
...
echo.
echo ========================================
echo All requirements installed for Virtual AI Assistant.
